          ...
          <CardContent className="p-8">
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                <Label htmlFor="caption" className="text-lg font-semibold  flex items-center gap-2">
              ...
              <div className="space-y-4">
                ...
                {/* Drag and Drop Area */}
                <div className="border-2 border-dashed border-gray-300 hover:border-purple-300 rounded-xl p-8 text-center transition-all duration-200 cursor-pointer">
                  <Upload className="w-12 h-12 text-gray-400 mx-auto mb-4" />
                  <p className="text-lg font-medium dark:text-gray-400 text-gray-600 mb-2">
